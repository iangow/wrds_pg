...
Separate text tables are provided for the following table:

- `feed17_director_and_officer_chan`
...
feed17 <- tbl(pg, "feed17_director_and_officer_chan")
feed17_text <- tbl(pg, "feed17_director_and_officer_chan_text")

feed17_w_text <-
    feed17 |>
    inner_join(feed17_text)
